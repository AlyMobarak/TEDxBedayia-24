...
export default function BookGroupTicketPage() {
    return (<center className='wrapper'>
        ...
        <section id="book-ticket" className="mx-0 w-[100vw] max-w-[100vw] pt-[6.75rem] px-[11rem] max-tablet:px-[6rem] max-phone:px-0 max-phone:w-[80vw] max-phone:max-w-[80vw] text-start">
            
            <h1 className="text-white font-title text-[3.5em]/[4.25rem] tracking-[-0.035rem] font-semibold text-start w-[30rem] max-phone:w-[80vw]">Booking a Group Ticket<span className="text-primary">.</span></h1>
            <span className="font-body text-white">Not what you&apos;re looking for? Click <Link href="/booking/one" className="text-secondary-300">here</Link> to book an individual ticket!</span>
            <p className="font-body mt-4 text-text-gray-dark text-start">Note: For outsiders, one of our members will contact you regarding your ticket. <br />Due to space constraints and limits, not everyone who applies will get a ticket.<br /><br /><span className="font-bold text-text-gray-light">Date</span>: Friday, 16th February, 2024<br /><span className="font-bold text-text-gray-light hidden">Time</span><br /><span className="font-bold text-text-gray-light">Location</span>: Bedayia International School, Gate 2<br /><span className="font-bold text-text-gray-light">Group Ticket</span>: <s>300 LE</s> 250 LE each, total 1,000 EGP.<br /><br /><span className="text-white">Hurry up and reserve your place now!</span></p>
