        ...
        <div>
          ...
          <div className="ml-2 max-tablet:ml-0 mt-6 max-phone:mt-[1.125rem] flex gap-4 max-phone:gap-2 flex-row max-phone:flex-col items-end max-phone:items-center max-phone:justify-center justify-center">
            <motion.div
              ...
              transition={{ ease: 'easeInOut', duration: 0.75 }}
            >
              <button disabled className="primary py-6 max-phone:py-[1.125rem] justify-center opacity-50 disabled text-center items-center shrink-0 w-[16.25rem] max-phone:w-[16rem] font-button bg-primary rounded-2xl" onClick={() => router.push('/booking/one')}>Book a Ticket</button>
            </motion.div>
