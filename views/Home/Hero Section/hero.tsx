...
function testimonial(avatar_url: string, role: string, name: string, quote: string, alt: boolean) {
  if (alt) return (<div className="w-[38.5rem] h-[6.75rem] max-phone:w-[28.875rem] max-phone:h-[5.0625rem] px-10 py-4 bg-secondary-400 rounded-[1rem] flex flex-row gap-4 justify-start items-center" style={{backgroundImage: "url(\"/Hero Section/Vector Art Testimonial.png\")", backgroundSize: "100% 100%", backgroundRepeat: "no-repeat"}}>
  ...
  return (<div className="w-[38.5rem] h-[6.75rem] max-phone:w-[28.875rem] max-phone:h-[5.0625rem] px-10 py-4 bg-primary-400 rounded-[1rem] flex flex-row gap-4 justify-start items-center" style={{backgroundImage: "url(\"/Hero Section/Vector Art Testimonial.png\")", backgroundSize: "100% 100%", backgroundRepeat: "no-repeat"}}>
