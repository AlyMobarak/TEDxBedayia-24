    ...
    return (<section id="speakers" className="mx-0 w-[100%] max-w-[100vw] mt-[-6.75rem] max-phone:pt-[10rem] max-tablet:pt-[5rem] mb-[4.5rem]">
        ...
        <div id="speakers-container" className='max-phone:flex-col w-screen max-phone:gap-0 max-phone:p-0 max-phone:m-0'>
            <div id="speakers-container1" className='max-phone:p-0 max-phone:m-0 max-phone:flex-col'>
                ...
                { speakerCard("Youssef Sabry", "Behind the scenes of Podcasts", "Tune in to the TEDx stage on February 16th for an auditory adventure with Youssef Sabry, a master podcaster. He'll reveal business secrets and podcasting pearls that promise to turn your daily commute into a riveting masterclass of captivating insights.", "From microphone to mindshare, Youssef Sabry, a podcast owner, will take the TEDx stage on the 16th of February. In a speech centered around business secrets & his podcast, Youssef will definitely transform your commute into a masterclass with his alluring insights! Don't miss his speech!", "/speakers/youssef-sabry.png", "youssefsabry") }
                { chainedCard() }
                { chainedCard() }
            </div>
