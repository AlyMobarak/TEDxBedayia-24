    ...
    return (<section id="speakers" className="mx-0 w-[100%] max-w-[100vw] mt-[-6.75rem] max-phone:pt-[10rem] max-tablet:pt-[5rem] mb-[4.5rem]">
        ...
        <div id="speakers-container" className='max-phone:flex-col w-screen max-phone:gap-0 max-phone:p-0 max-phone:m-0'>
            ...
            <div id="speakers-container2" className='max-phone:p-0 max-phone:flex-col'>
                ...
                { speakerCard("Hedaya Malak", "The Price of Being Exceptional", "Get ready to be swept off your feet at TEDx this year by Hedaya Malak, the Olympic taekwondo titan who clinched every medal in her path to glory.", "The speaker with the strongest kick will definitely kick off this years TEDx. Await the olympic legend Hedaya Malak, the taekwondo champion who grabbed on all medals on her way to pave her way to success. She's here to share her sports journey and her path towards athletic sublimity.", "/speakers/hedaya-malak.png", "hedayamalak") }
                { speakerCard("Alia Osman", "From Flame to Fame", "The founder of Gammbaz, a sustainable candle brand, Alia lights up the stage with her entrepreneurial spirit. Learn how she transformed a hobby into a thriving eco-conscious business. Be inspired by her story of innovation and fiery passion!", "In a speech sizzling with passion, Alia, a young entrepreneur & founder of Gammbaz, will illuminate the power of one’s potential by sharing her journey of building a sustainable candle brand. Witness her inspirational journey as a business owner and learn how she turned her avocations into a successful project at TEDx ’24!", "/speakers/alia-osman.png", "gammbaz") }
                { chainedCard() }
            </div>
        </div>
    </section>);
