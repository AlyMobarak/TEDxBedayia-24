...
export default function Theme() {
    return (<section id="theme" className="mx-0 w-[100%] max-w-[100vw] mt-16 mb-[4.5rem] relative">
        ...
        <div>
            ...
            <p className="text-white text-center font-body w-[40rem] max-phone:w-[85vw] mt-4 max-phone:mt-3 max-tablet:mt-2">The term <span className='bg-accent rounded-[0.75rem] font-bold pl-4 pr-2 inline-flex align-start justify-start m-0 w-max py-1'><span>Dreamscape</span><Image className="h-4 w-4" src="/mini-stars-dreamscape.png" height={28} width={25} alt=''></Image></span> evokes a sense of wonder and fascination, transporting us to a world where we delve into the vast landscapes of our minds, with limitless imagination. It symbolizes the power of dreams, both big and small, to shape our lives and the world around us. Dreamscape is a reminder that remarkable achievements often begin with a simple dream, a spark of inspiration that leads to innovation.</p>
        </div>
    </section>);
}